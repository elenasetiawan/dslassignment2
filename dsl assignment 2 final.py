...
brazil["CO2_Emissions_MA"] = brazil["CO2_Emissions"].rolling(window=5).mean()

mali["CO2_Emissions_MA"] = mali["CO2_Emissions"].rolling(window=5).mean()


plt.figure(figsize=(12, 6))

plt.plot(australia.index, australia["CO2_Emissions"], label="Australia (Original)", color="blue", alpha=0.5)
plt.plot(australia.index, australia["CO2_Emissions_MA"], label="Australia (Moving Average)", color="blue")

plt.plot(brazil.index, brazil["CO2_Emissions"], label="Brazil (Original)", color="green", alpha=0.5)
plt.plot(brazil.index, brazil["CO2_Emissions_MA"], label="Brazil (Moving Average)", color="green")
